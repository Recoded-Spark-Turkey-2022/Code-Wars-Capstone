...
const Requestsubmit = () =>{
  ...
  navigate("/")
    ...
    <button type="submit" onClick={handleClick} className='lg:text-xl md:text-1xl sm:text-sm rounded-md box-border py-2 transition-all duration-250 bg-cyan-400 hover:bg-cyan-500 hover:text-white w-2/7 m-auto '  > Back to Home </button>
</div>
    </div>   
    </>
    )
