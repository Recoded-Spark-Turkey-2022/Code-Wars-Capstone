...
export default function Careers() {
  ...
  return (
    <div>
      <HeaderBooking
        Header={t('CAREERS AT HEALING')}
        par={t('Be a part of making people feel better.')}
      />
      <div
      ...
      {showContent && (
        <div className=" bg-blue">
          <HeaderBooking
            Header={t('CURRENT OPEN POSITIONS')}
            par={t(
          ...
          <div className="lg:flex flex-row justify-between lg:w-[80rem] sm:w-[60rem] pr-[7rem] p-[1rem] pl-20 ">
            ...
            <div>
              <a
                ...
                className=" text-3xl text-cyan-400 hover:text-black visited:text-black-200 "
              >
                {t('Senior Software Developer | Backend | Remote in the USA')}
              </a>
            ...
            <div className="">
              <p className=" text-3xl  text-cyan-400 hover:text-black">
                {t('Engineering')}
              </p>
              <p className=" text-xl text-gray-700">
