...
let imageurl ;
  ...
  return ( 
<div data-Testid="blogarticle" id={id} className=" flex flex-col justify-center items-start lg:ml-[12rem] sm:ml-[10rem]">
...
<p className=" 2xl:text-l sm:text-m font-light leading-loose uppercase" >{filterbyid[0].paragraph}</p>
