...
const buttonHanler = (e)=>{
    ...
    return (
        <div>
            <div className='flex flex-col shadow-md p-10  text-center rounded-lg w-9/12 lg:ml-40 md:ml-20 mb-20  '>
        ...
        <button type="submit" className='lg:text-2xl md:text-1xl sm:text-sm rounded-md box-border py-2 transition-all duration-250 bg-cyan-400 hover:bg-cyan-500 hover:text-white w-2/6 m-auto ' onClick={buttonHanler} > Purechase </button>
