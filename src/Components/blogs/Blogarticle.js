...
function Blogarticle() {
  ...
  return (
    <div
      ...
      id={id}
      className=" flex flex-col justify-center items-start ml-[12rem]"
    >
      <img
      ...
      <div className="space-y-9  ml-10 xl:w-[55rem]">
        ...
        <p className=" 2xl:text-l sm:text-l font-light leading-loose uppercase">
          {filterbyid[0].paragraph}
        </p>
        <div className="pt-[2rem]">
          <h4 className="2xl:text-5xl sm:text-4xl  uppercase pb-[1rem] ">
            {filterbyid[0].header1}
          </h4>
