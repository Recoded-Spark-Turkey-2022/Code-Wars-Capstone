  ...
  const handlegoogle = ()=>{
   ...
   const handlefacebook = ()=>{
    ...
    return (
      ...
      <button type='button'  style={{height: 32, width: 32}} onClick={handlegoogle}><img src={googleicon} alt="Google Icon" /> </button>

          
        <button type="button" style={{height: 32, width: 32}} onClick={handlefacebook} > <img src={facebookicon}  alt="facebookicon" />  </button> 
